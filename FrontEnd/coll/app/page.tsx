          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="hover:text-white transition">History</Link></li>
                <li><Link href="#" className="hover:text-white transition">Mission & Vision</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="hover:text-white transition">Faculty</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="hover:text-white transition">Eligibility</Link></li>
                <li><Link href="#" className="hover:text-white transition">Scholarships</Link></li>
              </ul>
            </div>
            <div>
